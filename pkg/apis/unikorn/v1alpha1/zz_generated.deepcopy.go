...
func (in *ComputeInstanceSpec) DeepCopyInto(out *ComputeInstanceSpec) {
	*out = *in
	...
	if in.Volumes != nil {
		...
		*out = make([]ComputeInstanceVolumeSpec, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *ComputeInstanceStatus) DeepCopyInto(out *ComputeInstanceStatus) {
	*out = *in
	...
	if in.Volumes != nil {
		in, out := &in.Volumes, &out.Volumes
		*out = make([]ComputeInstanceVolumeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeInstanceVolumeSpec) DeepCopyInto(out *ComputeInstanceVolumeSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComputeInstanceVolumeSpec.
func (in *ComputeInstanceVolumeSpec) DeepCopy() *ComputeInstanceVolumeSpec {
	if in == nil {
		return nil
	}
	out := new(ComputeInstanceVolumeSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeInstanceVolumeStatus) DeepCopyInto(out *ComputeInstanceVolumeStatus) {
	*out = *in
	if in.Device != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComputeInstanceVolumeStatus.
func (in *ComputeInstanceVolumeStatus) DeepCopy() *ComputeInstanceVolumeStatus {
	if in == nil {
		return nil
	}
	out := new(ComputeInstanceVolumeStatus)
	in.DeepCopyInto(out)
	return out
}
