...
func (c *Client) CreateConsoleSession(ctx context.Context, organizationID, projectID, identityID, serverID string) (*regionapi.ConsoleSessionResponse, error) {
	...
	resp, err := client.PostApiV1OrganizationsOrganizationIDProjectsProjectIDIdentitiesIdentityIDServersServerIDConsolesessionsWithResponse(ctx, organizationID, projectID, identityID, serverID)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetConsoleOutput(ctx context.Context, organizationID, projectID, identityID, serverID string, request regionapi.GetApiV1OrganizationsOrganizationIDProjectsProjectIDIdentitiesIdentityIDServersServerIDConsoleoutputJSONRequestBody) (*regionapi.ConsoleOutputResponse, error) {
	client, err := c.Client(ctx)
	if err != nil {
		return nil, err
	}

	resp, err := client.GetApiV1OrganizationsOrganizationIDProjectsProjectIDIdentitiesIdentityIDServersServerIDConsoleoutputWithResponse(ctx, organizationID, projectID, identityID, serverID, request)
	if err != nil {
		return nil, err
	}
